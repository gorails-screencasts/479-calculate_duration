...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Series.count") do
      post series_index_url, params: { series: { duration: @series.duration, title: @series.title } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { duration: @series.duration, title: @series.title } }
