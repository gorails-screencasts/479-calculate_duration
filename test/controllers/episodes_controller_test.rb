...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference("Episode.count") do
      post episodes_url, params: { episode: { duration: @episode.duration, series_id: @episode.series_id, title: @episode.title } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { duration: @episode.duration, series_id: @episode.series_id, title: @episode.title } }
